...
{
  // Re-plan from the latest robot state before sending each motion.
...
int main(int argc, char * argv[])
{
  ...
  // Add a table and two simple obstacles so the arm plans around the scene.
  ...
  // Execute the required pick-and-place style sequence from the assignment.
